...
# CoreDNS rewrite NOT needed: k3s Traefik comes with ServiceLB (svclb-traefik) on every node.
# All *.yas.local.com DNS resolves to the master IP, Traefik routes it via Ingress rules.
